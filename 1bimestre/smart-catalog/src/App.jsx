...
// A Fonte de Verdade: nossa base de dados
const produtos = [
...
export default function App() {
  // Controle de estado simulado (mude para "notebook", "celular", etc. para testar a filtragem)
  const categoriaAtiva = "audio";

  // O Filtro: separando apenas a categoria desejada
  ...
  return (
    <div className="container">
      ...
      {/* Renderização da grade repassando apenas os itens que passaram no .filter() */}
